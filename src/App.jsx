  ...
  return (
    <div className="min-h-screen bg-gray-200 flex items-center justify-center p-6">
      <div className="flex gap-6">
        ...
        {/* ================= RECEIPT ================= */}
        <div className="flex w-[850px] bg-white shadow-lg border relative print:border-none">
          ...
          <div className="flex-1 p-6 text-[14px] relative">
            ...
            {/* PAID SEAL */}
            {data.paid && (
              <div className="absolute top-28 right-20 rotate-[-20deg]">
            ...
            <div className="absolute bottom-6 right-6 text-center">
              {data.signature && (
                <img src={data.signature} alt="signature" className="h-10 mx-auto" />
              )}
        ...
        {/* ================= CONTROL PANEL ================= */}
        <div className="bg-white p-4 w-[300px] rounded shadow print:hidden">
          ...
          <input name="paymentMethod" placeholder="Payment Method" onChange={handleChange} className="input" />
          <input name="reason" placeholder="Purpose" onChange={handleChange} className="input" />
